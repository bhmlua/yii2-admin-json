...
namespace bhml\admin\models;

use Exception;
use Yii;
use bhml\admin\components\Configs;
use bhml\admin\components\Helper;
use bhml\admin\components\RouteRule;
 ...
 * @since 1.0
 */
class Route extends \bhml\admin\BaseObject
{
    const CACHE_TAG = 'bhml.admin.route';
