...
namespace bhml\admin\components;
 ...
 *
 * ```
 * Yii::$container->set('bhml\admin\components\Configs',[
 *     'cache' => [
 *         'class' => 'yii\caching\DbCache',
 *         'db' => ['dsn' => 'sqlite:@runtime/admin-cache.db'],
 *     ],
 ...
 * @since 1.0
 */
class Configs extends \bhml\admin\BaseObject
{
    const CACHE_TAG = 'bhml.admin';
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'bhml.admin.configs', []);
